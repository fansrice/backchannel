...
class PostVotesControllerTest < ActionController::TestCase
  ...
  test "should create post_vote" do
    assert_difference('PostVote.count') do
      post :create, post_vote: { post_id: @post_vote.post_id, quantity: @post_vote.quantity, user_id: @post_vote.user_id, voter_id: @post_vote.voter_id }
    end
  ...
  test "should update post_vote" do
    patch :update, id: @post_vote, post_vote: { post_id: @post_vote.post_id, quantity: @post_vote.quantity, user_id: @post_vote.user_id, voter_id: @post_vote.voter_id }
    assert_redirected_to post_vote_path(assigns(:post_vote))
  end
